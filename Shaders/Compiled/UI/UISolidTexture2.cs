...
namespace ShaderMaterials.Shaders
{
	public class UISolidTexture2Material : MaterialI
	{
		...
		public delegate void ApplyObjectMeshCallbackMethod(UISolidTexture2Material material, ObjectMesh objectMesh);
		public static ApplyObjectMeshCallbackMethod ApplyObjectMeshCallback;
		
		public delegate void ApplyInstanceObjectMeshCallbackMethod(UISolidTexture2Material material, InstanceObjectMesh intanceObjectMesh);
