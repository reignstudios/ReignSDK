...
namespace Reign.Video
{
	...
	public class ImagePVR : Image
	{
		...
		#region Constructors
		public ImagePVR(string fileName, bool flip, Loader.LoadedCallbackMethod loadedCallback, Loader.FailedToLoadCallbackMethod failedToLoadCallback)
		{
		...
		public ImagePVR(Stream stream, bool flip, Loader.LoadedCallbackMethod loadedCallback, Loader.FailedToLoadCallbackMethod failedToLoadCallback)
		{
