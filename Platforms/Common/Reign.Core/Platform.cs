namespace Reign.Core
{
	public abstract class IPlatform
	{
		...
		public bool AutoDisposedGL {get; internal set;}
		#endif

		public static IPlatform Singleton;
		public IApplication CurrentApplication {get; private set;}
		protected Time time;

		public abstract Size2 ScreenSize {get;}
		...
		public virtual void Run(IApplication application, int fps)
		{
...
//		public static void Run(IApplication application, int fps)
//		{
//			CurrentApplication = application;
