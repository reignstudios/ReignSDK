...
namespace BEPUphysics.Entities
{
        ...
        ICollisionRulesOwner
    {
        ...
        internal Matrix3 orientationMatrix = Matrix3.Identity;
        ...
        public Quaternion Orientation
        {
            ...
            set
            {
                ...
                Matrix3.FromQuaternion(ref orientation, out orientationMatrix);
                //Update inertia tensors for consistency.
                Matrix3 multiplied;
                Matrix3.MultiplyTransposed(ref orientationMatrix, ref localInertiaTensorInverse, out multiplied);
                Matrix3.Multiply(ref multiplied, ref orientationMatrix, out inertiaTensorInverse);
                Matrix3.MultiplyTransposed(ref orientationMatrix, ref localInertiaTensor, out multiplied);
                Matrix3.Multiply(ref multiplied, ref orientationMatrix, out inertiaTensor);
                activityInformation.Activate();
            }
        }
        /// <summary>
        ...
        public Matrix3 OrientationMatrix
        {
            ...
            set
            {
                Quaternion.FromMatrix3(ref value, out orientation);
        ...
        public Matrix4 WorldTransform
        {
            get
            {
				...
				Matrix4.FromAffineTransform(ref orientationMatrix, ref position, out worldTransform);
                return worldTransform;
            }
            set
            {
                Quaternion.FromMatrix4(ref value, out orientation);
                Orientation = orientation; //normalizes and sets.
        ...
        public Vector3 AngularVelocity
        {
            ...
            set
            {
                ...
                Vector3.Transform(ref value, ref inertiaTensor, out angularMomentum);
                activityInformation.Activate();
            }
        }
        /// <summary>
        ...
        public Vector3 AngularMomentum
        {
            get
            {
                ...
                {
                    Vector3 v;
                    Vector3.Transform(ref angularVelocity, ref inertiaTensor, out v);
                    return v;
                }
            }
            set
            {
                ...
                Vector3.Transform(ref value, ref inertiaTensorInverse, out angularVelocity);
                activityInformation.Activate();
            }
        }
        /// <summary>
        ...
        public Vector3 LinearVelocity
        {
            ...
            set
            {
                ...
                Vector3.Mul(ref linearVelocity, mass, out linearMomentum);
                activityInformation.Activate();
            }
        }
        /// <summary>
        ...
        public Vector3 LinearMomentum
        {
            ...
            set
            {
                ...
                Vector3.Mul(ref linearMomentum, inverseMass, out linearVelocity);
                activityInformation.Activate();
            }
        }
        /// <summary>
        ...
        internal Matrix3 inertiaTensorInverse;
        ///<summary>
        ...
        internal Matrix3 inertiaTensor;
        ///<summary>
        ...
        internal Matrix3 localInertiaTensor;
        ///<summary>
        /// Gets or sets the local inertia tensor of the entity.
        ///</summary>
        public Matrix3 LocalInertiaTensor
        {
            get
            {
            ...
            set
            {
                ...
                Matrix3.AdaptiveInvert(ref localInertiaTensor, out localInertiaTensorInverse);
                Matrix3 multiplied;
                Matrix3.MultiplyTransposed(ref orientationMatrix, ref localInertiaTensorInverse, out multiplied);
                Matrix3.Multiply(ref multiplied, ref orientationMatrix, out inertiaTensorInverse);
                Matrix3.MultiplyTransposed(ref orientationMatrix, ref localInertiaTensor, out multiplied);
        ...
        internal Matrix3 localInertiaTensorInverse;
        /// <summary>
        /// Gets or sets the local inertia tensor inverse of the entity.
        /// </summary>
        public Matrix3 LocalInertiaTensorInverse
        {
            get
            {
            ...
            set
            {
                ...
                Matrix3.AdaptiveInvert(ref localInertiaTensorInverse, out localInertiaTensor);
            ...
            set
            {
                ...
                else
                {
                    if (isDynamic)
                    {
                        ...
                        Matrix3 newInertia;
                        Matrix3.Mul(ref localInertiaTensor, value * inverseMass, out newInertia);
        ...
        public Entity(EntityCollidable collisionInformation, float mass, Matrix3 inertiaTensor)
            : this()
        {
        ...
        public Entity(EntityCollidable collisionInformation, float mass, Matrix3 inertiaTensor, float volume)
            : this()
        {
        ...
        ///<param name="mass">Mass of the entity.</param>
        /// <param name="inertiaTensor">Inertia tensor of the entity.</param>
        public Entity(EntityShape shape, float mass, Matrix3 inertiaTensor)
            : this()
        {
        ...
        /// <param name="inertiaTensor">Inertia tensor of the entity.</param>
        /// <param name="volume">Volume of the entity.</param>
        public Entity(EntityShape shape, float mass, Matrix3 inertiaTensor, float volume)
            : this()
        {
        ...
        protected internal void Initialize(EntityCollidable collisionInformation, float mass)
        {
            ...
            Matrix3.Mul(ref shapeInfo.VolumeDistribution, mass * InertiaHelper.InertiaTensorScale, out shapeInfo.VolumeDistribution);
        ...
        protected internal void Initialize(EntityCollidable collisionInformation, float mass, Matrix3 inertiaTensor)
        {
            CollisionInformation = collisionInformation;
        ...
        protected internal void Initialize(EntityCollidable collisionInformation, float mass, Matrix3 inertiaTensor, float volume)
        {
            CollisionInformation = collisionInformation;
            this.volume = volume;
            BecomeDynamic(mass, inertiaTensor);
        ...
        public void ApplyAngularImpulse(ref Vector3 impulse)
        {
            ...
            if (MotionSettings.ConserveAngularMomentum)
            {
                angularVelocity.X = angularMomentum.X * inertiaTensorInverse.X.X + angularMomentum.Y * inertiaTensorInverse.Y.X + angularMomentum.Z * inertiaTensorInverse.Z.X;
                angularVelocity.Y = angularMomentum.X * inertiaTensorInverse.X.Y + angularMomentum.Y * inertiaTensorInverse.Y.Y + angularMomentum.Z * inertiaTensorInverse.Z.Y;
                angularVelocity.Z = angularMomentum.X * inertiaTensorInverse.X.Z + angularMomentum.Y * inertiaTensorInverse.Y.Z + angularMomentum.Z * inertiaTensorInverse.Z.Z;
            }
            else
            {
                angularVelocity.X += impulse.X * inertiaTensorInverse.X.X + impulse.Y * inertiaTensorInverse.Y.X + impulse.Z * inertiaTensorInverse.Z.X;
                angularVelocity.Y += impulse.X * inertiaTensorInverse.X.Y + impulse.Y * inertiaTensorInverse.Y.Y + impulse.Z * inertiaTensorInverse.Z.Y;
                angularVelocity.Z += impulse.X * inertiaTensorInverse.X.Z + impulse.Y * inertiaTensorInverse.Y.Z + impulse.Z * inertiaTensorInverse.Z.Z;
            }
        }
        ...
        protected void OnShapeChanged(CollisionShape shape)
        {
            if (!IgnoreShapeChanges)
            {
                ...
                if (isDynamic)
                {
                    Matrix3.Mul(ref shapeInfo.VolumeDistribution, InertiaHelper.InertiaTensorScale * mass, out shapeInfo.VolumeDistribution);
                    LocalInertiaTensor = shapeInfo.VolumeDistribution;
                }
                else
                {
                    LocalInertiaTensorInverse = new Matrix3();
                }
            }
        }
        ...
        {
            Matrix3 inertiaTensor = collisionInformation.Shape.ComputeVolumeDistribution();
            Matrix3.Mul(ref inertiaTensor, mass * InertiaHelper.InertiaTensorScale, out inertiaTensor);
            BecomeDynamic(mass, inertiaTensor);
        }
        ...
        public void BecomeDynamic(float mass, Matrix3 localInertiaTensor)
        {
        ...
        void IForceUpdateable.UpdateForForces(float dt)
        {
            ...
            if (linear > 0)
            {
                Vector3.Mul(ref linearVelocity, (float)Math.Pow(MathUtilities.Clamp(1 - linear, 0, 1), dt), out linearVelocity);
            }
            ...
            {
                Vector3.Mul(ref angularMomentum, (float)Math.Pow(MathUtilities.Clamp(1 - angular, 0, 1), dt), out angularMomentum);
            }
            else if (angular > 0)
            {
                Vector3.Mul(ref angularVelocity, (float)Math.Pow(MathUtilities.Clamp(1 - angular, 0, 1), dt), out angularVelocity);
            }
            ...
            if (MotionSettings.ConserveAngularMomentum)
            {
                Vector3.Transform(ref angularMomentum, ref inertiaTensorInverse, out angularVelocity);
            }
            else
            {
                Vector3.Transform(ref angularVelocity, ref inertiaTensor, out angularMomentum);
            }
        }
        ...
        void ICCDPositionUpdateable.UpdatePositionContinuously(float dt)
        {
            ...
            Vector3 increment;
            Vector3.Mul(ref linearVelocity, dt * minimumToi, out increment);
        ...
        void IPositionUpdateable.PreUpdatePosition(float dt)
        {
            ...
            {
                Vector3.Mul(ref angularVelocity, dt * .5f, out increment);
            ...
            {
                Vector3.Mul(ref linearVelocity, dt, out increment);
                Vector3.Add(ref position, ref increment, out position);
        ...
        public float AngularDamping
        {
            ...
            set
            {
                angularDamping = MathUtilities.Clamp(value, 0, 1);
            }
        }
        ///<summary>
        ...
        public float LinearDamping
        {
            ...
            set
            {
                linearDamping = MathUtilities.Clamp(value, 0, 1);
            }
        }
