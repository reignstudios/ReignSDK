...
namespace BEPUphysics.Entities
{
    ...
    public class MorphableEntity : Entity
    {
        ...
        public MorphableEntity(EntityCollidable collisionInformation, float mass, Matrix3 inertiaTensor)
        ...
        public MorphableEntity(EntityCollidable collisionInformation, float mass, Matrix3 inertiaTensor, float volume)
        ...
        ///<param name="mass">Mass of the entity.</param>
        /// <param name="inertiaTensor">Inertia tensor of the entity.</param>
        public MorphableEntity(EntityShape shape, float mass, Matrix3 inertiaTensor)
        ...
        /// <param name="inertiaTensor">Inertia tensor of the entity.</param>
        /// <param name="volume">Volume of the entity.</param>
        public MorphableEntity(EntityShape shape, float mass, Matrix3 inertiaTensor, float volume)
        ...
        public void SetCollisionInformation(EntityCollidable newCollisionInformation, float newMass, Matrix3 newInertia)
        {
            //Temporarily remove the object from the space.  
            //The reset process will update any systems that need to be updated.
            //This is not thread safe, but this operation should not be performed mid-frame anyway.
