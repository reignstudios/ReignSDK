...
namespace BEPUphysics.Entities.Prefabs
{
    ...
    public class TransformableEntity : Entity<ConvexCollidable<TransformableShape>>
    {
        ...
        private TransformableEntity(ConvexShape shape, Matrix3 transform)
            : base(new ConvexCollidable<TransformableShape>(new TransformableShape(shape, transform)))
        {
        }

        private TransformableEntity(ConvexShape shape, Matrix3 transform, float mass)
        ...
        public TransformableEntity(Vector3 position, ConvexShape shape, Matrix3 transform, float mass)
        ...
        /// <param name="shape">Shape to transform.</param>
        /// <param name="transform">Transform to apply to the shape.</param>
        public TransformableEntity(Vector3 position, ConvexShape shape, Matrix3 transform)
        ...
        /// <param name="transform">Transform to apply to the shape.</param>
        /// <param name="mass">Mass of the object.</param>
        public TransformableEntity(MotionState motionState, ConvexShape shape, Matrix3 transform, float mass)
            : this(shape, transform, mass)
        {
        ...
        /// <param name="shape">Shape to transform.</param>
        /// <param name="transform">Transform to apply to the shape.</param>
        public TransformableEntity(MotionState motionState, ConvexShape shape, Matrix3 transform)
            : this(shape, transform)
        {
            MotionState = motionState;
        }
