...
namespace BEPUphysics.Entities.Prefabs
{
    ...
    public class MobileMesh : Entity<MobileMeshCollidable>
    {
        ...
        public MobileMesh(Vector3[] vertices, int[] indices, AffineTransform3 localTransform, MobileMeshSolidity solidity)
        {
        ...
        public MobileMesh(Vector3[] vertices, int[] indices,  AffineTransform3 localTransform, MobileMeshSolidity solidity, float mass)
        {
            ShapeDistributionInformation info;
            var shape = new MobileMeshShape(vertices, indices, localTransform, solidity, out info);
            Matrix3 inertia;
            Matrix3.Mul(ref info.VolumeDistribution, mass * InertiaHelper.InertiaTensorScale, out inertia);
