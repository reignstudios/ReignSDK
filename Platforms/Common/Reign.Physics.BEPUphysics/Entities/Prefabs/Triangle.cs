...
namespace BEPUphysics.Entities.Prefabs
{
    ...
    public class Triangle : Entity<ConvexCollidable<TriangleShape>>
    {
        ...
        public Vector3 VertexA
        {
            get
            {
                return CollisionInformation.Shape.VertexA.Transform(orientationMatrix) + position;
            }
            set
            {
                CollisionInformation.Shape.VertexA = (value - position).TransformTranspose(orientationMatrix);
            }
        }
        ///<summary>
        ...
        public Vector3 VertexB
        {
            get
            {
                return CollisionInformation.Shape.VertexB.Transform(orientationMatrix) + position;
            }
            set
            {
                CollisionInformation.Shape.VertexB = (value - position).TransformTranspose(orientationMatrix);
            }
        }
        ///<summary>
        ...
        public Vector3 VertexC
        {
            ...
            set
            {
                CollisionInformation.Shape.VertexC = (value - position).TransformTranspose(orientationMatrix);
            }
        }
