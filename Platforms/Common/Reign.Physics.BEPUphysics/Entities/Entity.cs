...
namespace BEPUphysics.Entities
{
    ...
    public class Entity<T> : Entity where T : EntityCollidable
    {
        ...
        public Entity(T collisionInformation, float mass, Matrix3 inertiaTensor)
        {
        ...
        public Entity(T collisionInformation, float mass, Matrix3 inertiaTensor, float volume)
        {
