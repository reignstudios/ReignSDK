    ...
    public class InterpolatedStatesManager : MultithreadedProcessingStage
    {
        ...
        internal void Enable()
        {
            ...
            lock (FlipLocker)
            {
                ...
                backBuffer = new RigidTransform3[initialCount];
                states = new RigidTransform3[initialCount];
        ...
        RigidTransform3[] backBuffer;
        RigidTransform3[] states = new RigidTransform3[64];
        ...
        public float BlendAmount
        {
            ...
            set
            {
                blendAmount = MathUtilities.Clamp(value, 0, 1);
            }
        }
        ...
        public void FlipBuffers()
        {
            lock (FlipLocker)
            {
                RigidTransform3[] formerFrontBuffer = states;
                states = backBuffer;
        ...
        public RigidTransform3 GetState(int motionStateIndex)
        {
        ...
        public void GetStates(RigidTransform3[] states)
        {
            lock (FlipLocker)
            {
        ...
        internal void Add(Entity e)
        {
            ...
            {
                var newStates = new RigidTransform3[states.Length * 2];
            ...
            {
                var newStates = new RigidTransform3[backBuffer.Length * 2];
