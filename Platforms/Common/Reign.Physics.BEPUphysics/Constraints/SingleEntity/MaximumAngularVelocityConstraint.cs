    ...
    public class MaximumAngularSpeedConstraint : SingleEntityConstraint, I3DImpulseConstraint
    {
        ...
        public override float SolveIteration()
        {
            ...
            if (angularSpeed > maximumSpeedSquared)
            {
                ...
                Vector3.Mul(ref entity.angularVelocity, -(angularSpeed - maximumSpeed) / angularSpeed, out impulse);

                //incorporate softness
                Vector3 softnessImpulse;
                Vector3.Mul(ref accumulatedImpulse, usedSoftness, out softnessImpulse);
                Vector3.Sub(ref impulse, ref softnessImpulse, out impulse);

                //Transform into impulse
                Vector3.Transform(ref impulse, ref effectiveMassMatrix, out impulse);
