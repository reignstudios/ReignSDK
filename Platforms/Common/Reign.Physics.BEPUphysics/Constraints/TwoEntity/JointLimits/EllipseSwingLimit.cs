    ...
    public class EllipseSwingLimit : JointLimit, I1DImpulseConstraintWithError, I1DJacobianConstraint
    {
        ...
        public Vector3 LocalTwistAxisB
        {
            ...
            set
            {
                ...
                Vector3.Transform(ref localTwistAxisB, ref connectionB.orientationMatrix, out worldTwistAxisB);
            }
        }
        ...
        public float MaximumAngleX
        {
            ...
            set { maximumAngleX = MathUtilities.Clamp(value, Toolbox.BigEpsilon, MathUtilities.Pi); }
        }
        ...
        public float MaximumAngleY
        {
            ...
            set { maximumAngleY = MathUtilities.Clamp(value, Toolbox.BigEpsilon, MathUtilities.Pi); }
        }
        ...
        public Vector3 TwistAxisB
        {
            ...
            set
            {
                ...
                Vector3.TransformTranspose(ref worldTwistAxisB, ref connectionB.orientationMatrix, out localTwistAxisB);
            }
        }
        ...
        public override void Update(float dt)
        {
            ...
            //float ellipseAngle = (float)Math.Atan2(angleY, angleX) + MathUtilities.PiOver2;
            ...
            Vector3.Mul(ref sphereTangentX, tangent.X, out jacobianA); //not actually jA, just storing it there.
            Vector3.Mul(ref sphereTangentY, tangent.Y, out jacobianB); //not actually jB, just storing it there.
