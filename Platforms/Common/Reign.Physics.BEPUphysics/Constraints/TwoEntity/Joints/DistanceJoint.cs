...
namespace BEPUphysics.Constraints.TwoEntity.Joints
{
    ...
    public class DistanceJoint : Joint, I1DImpulseConstraintWithError, I1DJacobianConstraint
    {
        ...
        public Vector3 LocalAnchorA
        {
            ...
            {
                localAnchorA = value;
                Vector3.Transform(ref localAnchorA, ref connectionA.orientationMatrix, out anchorA);
        ...
        public Vector3 LocalAnchorB
        {
            ...
            {
                localAnchorB = value;
                Vector3.Transform(ref localAnchorB, ref connectionB.orientationMatrix, out anchorB);
        ...
        public Vector3 WorldAnchorA
        {
            ...
            {
                anchorA = value;
                localAnchorA = (anchorA - connectionA.position).Transform(connectionA.orientation.Conjugate());
            }
        }
        ...
        public Vector3 WorldAnchorB
        {
            ...
            {
                anchorB = value;
                localAnchorB = (anchorB - connectionB.position).Transform(connectionB.orientation.Conjugate());
            }
        }
        ...
        public override void Update(float dt)
        {
            ...
            Vector3.Transform(ref localAnchorA, ref connectionA.orientationMatrix, out offsetA);
            Vector3.Transform(ref localAnchorB, ref connectionB.orientationMatrix, out offsetB);
            ...
            Vector3 separation;
            Vector3.Sub(ref anchorB, ref anchorA, out separation);
            ...
            {
                Vector3 aAngular;
                Vector3.Transform(ref jAngularA, ref connectionA.localInertiaTensorInverse, out aAngular);
                Vector3.Cross(ref aAngular, ref offsetA, out aAngular);
                Vector3 bAngular;
                Vector3.Transform(ref jAngularB, ref connectionB.localInertiaTensorInverse, out bAngular);
            ...
            biasVelocity = MathUtilities.Clamp(error * errorReduction, -maxCorrectiveVelocity, maxCorrectiveVelocity);
