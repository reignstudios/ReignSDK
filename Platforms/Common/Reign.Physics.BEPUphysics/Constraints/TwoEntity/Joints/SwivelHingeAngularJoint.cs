...
namespace BEPUphysics.Constraints.TwoEntity.Joints
{
    ...
    public class SwivelHingeAngularJoint : Joint, I1DImpulseConstraintWithError, I1DJacobianConstraint
    {
        ...
        public Vector3 LocalHingeAxis
        {
            ...
            set
            {
                localHingeAxis = value.Normalize();
                Vector3.Transform(ref localHingeAxis, ref connectionA.orientationMatrix, out worldHingeAxis);
            }
        }
        ...
        public Vector3 LocalTwistAxis
        {
            ...
            set
            {
                localTwistAxis = value.Normalize();
                Vector3.Transform(ref localTwistAxis, ref connectionB.orientationMatrix, out worldTwistAxis);
            }
        }
        ...
        public Vector3 WorldHingeAxis
        {
            ...
            set
            {
                worldHingeAxis = value.Normalize();
        ...
        public Vector3 WorldTwistAxis
        {
            ...
            set
            {
                worldTwistAxis = value.Normalize();
                Quaternion conjugate;
        ...
        public override void Update(float dt)
        {
            ...
            if (length > Toolbox.Epsilon)
                Vector3.Div(ref jacobianA, (float)Math.Sqrt(length), out jacobianA);
            else
