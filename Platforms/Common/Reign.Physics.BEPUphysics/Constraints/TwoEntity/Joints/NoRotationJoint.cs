...
namespace BEPUphysics.Constraints.TwoEntity.Joints
{
    ...
    public class NoRotationJoint : Joint, I3DImpulseConstraintWithError, I3DJacobianConstraint
    {
        ...
        public NoRotationJoint(Entity connectionA, Entity connectionB)
        {
            ...
            initialQuaternionConjugateA = ConnectionA.orientation.Conjugate();
            initialQuaternionConjugateB = ConnectionB.orientation.Conjugate();
        }
        ...
        {
            get { return initialQuaternionConjugateA.Conjugate(); }
            set { initialQuaternionConjugateA = value.Conjugate(); }
        }
        ...
        {
            get { return initialQuaternionConjugateB.Conjugate(); }
            set { initialQuaternionConjugateB = value.Conjugate(); }
        }
        ...
        public Vector3 RelativeVelocity
        {
            get
            {
                ...
                Vector3.Sub(ref connectionB.angularVelocity, ref connectionA.angularVelocity, out velocityDifference);
        ...
        public override float SolveIteration()
        {
            ...
            Vector3.Mul(ref accumulatedImpulse, softness, out softnessVector);

            Vector3 lambda;
            Vector3.Add(ref velocityDifference, ref biasVelocity, out lambda);
            Vector3.Sub(ref lambda, ref softnessVector, out lambda);
            ...
            {
                Vector3 torqueB;
                Vector3.Neg(ref lambda, out torqueB);
        ...
        public override void Update(float dt)
        {
            ...
            Matrix3.Add(ref connectionA.inertiaTensorInverse, ref connectionB.inertiaTensorInverse, out effectiveMassMatrix);
            effectiveMassMatrix.X.X += softness;
            effectiveMassMatrix.Y.Y += softness;
            effectiveMassMatrix.Z.Z += softness;
        ...
        public override void ExclusiveUpdate()
        {
            ...
            {
                Vector3 torqueB;
                Vector3.Neg(ref accumulatedImpulse, out torqueB);
                connectionB.ApplyAngularImpulse(ref torqueB);
            }
        } 
    }
