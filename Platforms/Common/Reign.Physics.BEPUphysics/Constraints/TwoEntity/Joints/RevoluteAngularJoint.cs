...
namespace BEPUphysics.Constraints.TwoEntity.Joints
{
    ...
    public class RevoluteAngularJoint : Joint, I2DImpulseConstraintWithError, I2DJacobianConstraint
    {
        ...
        private Matrix2 effectiveMassMatrix;
        ...
        public Vector3 LocalFreeAxisA
        {
            ...
            set
            {
                localAxisA = value.Normalize();
                Vector3.Transform(ref localAxisA, ref connectionA.orientationMatrix, out worldAxisA);
        ...
        public Vector3 LocalFreeAxisB
        {
            ...
            set
            {
                localAxisB = value.Normalize();
                Vector3.Transform(ref localAxisB, ref connectionB.orientationMatrix, out worldAxisB);
            }
        }
        ...
        public Vector3 WorldFreeAxisA
        {
            ...
            set
            {
                worldAxisA = value.Normalize();
                Vector3.TransformTranspose(ref worldAxisA, ref connectionA.orientationMatrix, out localAxisA);
                UpdateRestrictedAxes();
            }
        }
        ...
        public Vector3 WorldFreeAxisB
        {
            ...
            set
            {
                worldAxisB = value.Normalize();
                Vector3.TransformTranspose(ref worldAxisB, ref connectionB.orientationMatrix, out localAxisB);
            }
        }
        ...
        public Vector2 RelativeVelocity
        {
            ...
            {
                Vector3 velocity;
                Vector3.Sub(ref connectionA.angularVelocity, ref connectionB.angularVelocity, out velocity);
        ...
        public override float SolveIteration()
        {
            ...
            Vector2.Mul(ref accumulatedImpulse, softness, out softnessImpulse);
            Vector2.Add(ref lambda, ref softnessImpulse, out lambda);
            Vector2.Transform(ref lambda, ref effectiveMassMatrix, out lambda);
            ...
            {
                Vector3.Neg(ref impulse, out impulse);
        ...
        public override void Update(float dt)
        {
            ...
            Vector3.Transform(ref localConstrainedAxis1, ref connectionA.orientationMatrix, out worldConstrainedAxis1);
            Vector3.Transform(ref localConstrainedAxis2, ref connectionA.orientationMatrix, out worldConstrainedAxis2);
            ...
            {
                Matrix3 inertiaTensorSum;
                Matrix3.Add(ref connectionA.inertiaTensorInverse, ref connectionB.inertiaTensorInverse, out inertiaTensorSum);

                Vector3.Transform(ref worldConstrainedAxis1, ref inertiaTensorSum, out axis1I);
                Vector3.Transform(ref worldConstrainedAxis2, ref inertiaTensorSum, out axis2I);
            }
            else if (connectionA.isDynamic && !connectionB.isDynamic)
            {
                Vector3.Transform(ref worldConstrainedAxis1, ref connectionA.inertiaTensorInverse, out axis1I);
                Vector3.Transform(ref worldConstrainedAxis2, ref connectionA.inertiaTensorInverse, out axis2I);
            }
            else if (!connectionA.isDynamic && connectionB.isDynamic)
            {
                Vector3.Transform(ref worldConstrainedAxis1, ref connectionB.inertiaTensorInverse, out axis1I);
                Vector3.Transform(ref worldConstrainedAxis2, ref connectionB.inertiaTensorInverse, out axis2I);
            }
            else
            {
            ...
            Vector3.Dot(ref axis1I, ref worldConstrainedAxis1, out effectiveMassMatrix.X.X);
            Vector3.Dot(ref axis1I, ref worldConstrainedAxis2, out effectiveMassMatrix.X.Y);
            Vector3.Dot(ref axis2I, ref worldConstrainedAxis1, out effectiveMassMatrix.Y.X);
            Vector3.Dot(ref axis2I, ref worldConstrainedAxis2, out effectiveMassMatrix.Y.Y);
            effectiveMassMatrix.X.X += softness;
            effectiveMassMatrix.Y.Y += softness;
            Matrix2.Invert(ref effectiveMassMatrix, out effectiveMassMatrix);
            Matrix2.Neg(ref effectiveMassMatrix, out effectiveMassMatrix);
        ...
        {
            localConstrainedAxis1 = Vector3.Up.Cross(localAxisA);
            if (localConstrainedAxis1.LengthSquared() < .001f)
            {
                localConstrainedAxis1 = Vector3.Right.Cross(localAxisA);
            }
            localConstrainedAxis2 = localAxisA.Cross(localConstrainedAxis1);
            localConstrainedAxis1 = localConstrainedAxis1.Normalize();
            localConstrainedAxis2 = localConstrainedAxis2.Normalize();
        }
    }
}