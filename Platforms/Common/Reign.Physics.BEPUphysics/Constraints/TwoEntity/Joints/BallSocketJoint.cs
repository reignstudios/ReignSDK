...
namespace BEPUphysics.Constraints.TwoEntity.Joints
{
    ...
    public class BallSocketJoint : Joint, I3DImpulseConstraintWithError, I3DJacobianConstraint
    {
        ...
        private Matrix3 massMatrix;
        private Vector3 error;
        private Matrix3 rACrossProduct;
        private Matrix3 rBCrossProduct;
        ...
        public Vector3 LocalOffsetA
        {
            ...
            {
                localAnchorA = value;
                Vector3.Transform(ref localAnchorA, ref connectionA.orientationMatrix, out worldOffsetA); 
            }
        }
        ...
        public Vector3 LocalOffsetB
        {
            ...
            {
                localAnchorB = value;
                Vector3.Transform(ref localAnchorB, ref connectionB.orientationMatrix, out worldOffsetB); 
            }
        }
        ...
        public Vector3 OffsetA
        {
            ...
            {
                worldOffsetA = value;
                Vector3.TransformTranspose(ref worldOffsetA, ref connectionA.orientationMatrix, out localAnchorA);
            }
        }
        ...
        public Vector3 OffsetB
        {
            ...
            {
                worldOffsetB = value;
                Vector3.TransformTranspose(ref worldOffsetB, ref connectionB.orientationMatrix, out localAnchorB);
            }
        }
        ...
        public void GetAngularJacobianA(out Vector3 jacobianX, out Vector3 jacobianY, out Vector3 jacobianZ)
        {
            ...
            jacobianZ = rACrossProduct.Front;
        }
        ...
        public void GetAngularJacobianB(out Vector3 jacobianX, out Vector3 jacobianY, out Vector3 jacobianZ)
        {
            ...
            jacobianZ = rBCrossProduct.Front;
        }
        ...
        public void GetMassMatrix(out Matrix3 outputMassMatrix)
        {
        ...
        public override void Update(float dt)
        {
            ...
            //Mass Matrix4
            Matrix3 k;
            Matrix3 linearComponent;
            Matrix3.FromCross(ref worldOffsetA, out rACrossProduct);
            Matrix3.FromCross(ref worldOffsetB, out rBCrossProduct);
            if (connectionA.isDynamic && connectionB.isDynamic)
            {
                Matrix3.FromScale(connectionA.inverseMass + connectionB.inverseMass, out linearComponent);
                Matrix3 angularComponentA, angularComponentB;
                Matrix3.Multiply(ref rACrossProduct, ref connectionA.inertiaTensorInverse, out angularComponentA);
                Matrix3.Multiply(ref rBCrossProduct, ref connectionB.inertiaTensorInverse, out angularComponentB);
                Matrix3.Multiply(ref angularComponentA, ref rACrossProduct, out angularComponentA);
                Matrix3.Multiply(ref angularComponentB, ref rBCrossProduct, out angularComponentB);
                Matrix3.Sub(ref linearComponent, ref angularComponentA, out k);
                Matrix3.Sub(ref k, ref angularComponentB, out k);
            }
            else if (connectionA.isDynamic && !connectionB.isDynamic)
            {
                Matrix3.FromScale(connectionA.inverseMass, out linearComponent);
                Matrix3 angularComponentA;
                Matrix3.Multiply(ref rACrossProduct, ref connectionA.inertiaTensorInverse, out angularComponentA);
                Matrix3.Multiply(ref angularComponentA, ref rACrossProduct, out angularComponentA);
                Matrix3.Sub(ref linearComponent, ref angularComponentA, out k);
            }
            ...
            {
                Matrix3.FromScale(connectionB.inverseMass, out linearComponent);
                Matrix3 angularComponentB;
                Matrix3.Multiply(ref rBCrossProduct, ref connectionB.inertiaTensorInverse, out angularComponentB);
                Matrix3.Multiply(ref angularComponentB, ref rBCrossProduct, out angularComponentB);
                Matrix3.Sub(ref linearComponent, ref angularComponentB, out k);
            }
            else
            {
            ...
            k.Y.Y += softness;
            k.Z.Z += softness;
            Matrix3.Invert(ref k, out massMatrix);

            Vector3.Add(ref connectionB.position, ref worldOffsetB, out error);
            Vector3.Sub(ref error, ref connectionA.position, out error);
            Vector3.Sub(ref error, ref worldOffsetA, out error);


            Vector3.Mul(ref error, -errorReductionParameter, out biasVelocity);
        ...
        public override float SolveIteration()
        {
            ...
            Vector3.Transform(ref lambda, ref massMatrix, out lambda);
