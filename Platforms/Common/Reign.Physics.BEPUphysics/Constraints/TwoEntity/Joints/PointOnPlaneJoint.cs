    ...
    public class PointOnPlaneJoint : Joint, I1DImpulseConstraintWithError, I1DJacobianConstraint
    {
        ...
        public Vector3 LocalPlaneAnchor
        {
            ...
            set
            {
                ...
                Vector3.Transform(ref localPlaneAnchor, ref connectionA.orientationMatrix, out worldPlaneAnchor);
        ...
        public Vector3 LocalPlaneNormal
        {
            ...
            set
            {
                localPlaneNormal = value.Normalize();
                Vector3.Transform(ref localPlaneNormal, ref connectionA.orientationMatrix, out worldPlaneNormal);
            }
        }
        ...
        public Vector3 LocalPointAnchor
        {
            ...
            set
            {
                ...
                Vector3.Transform(ref localPointAnchor, ref connectionB.orientationMatrix, out worldPointAnchor);
        ...
        public Vector3 PlaneAnchor
        {
            ...
            set
            {
                ...
                Vector3.TransformTranspose(ref localPlaneAnchor, ref connectionA.orientationMatrix, out localPlaneAnchor);
        ...
        public Vector3 PlaneNormal
        {
            ...
            set
            {
                worldPlaneNormal = value.Normalize();
                Vector3.TransformTranspose(ref worldPlaneNormal, ref connectionA.orientationMatrix, out localPlaneNormal);
            }
        }
        ...
        public Vector3 PointAnchor
        {
            ...
            set
            {
                ...
                Vector3.TransformTranspose(ref localPointAnchor, ref connectionB.orientationMatrix, out localPointAnchor);
        ...
        public override float SolveIteration()
        {
            ...
            Vector3 impulse;
            Vector3 torque;
            Vector3.Mul(ref worldPlaneNormal, lambda, out impulse);
            if (connectionA.isDynamic)
            {
                Vector3.Mul(ref rAcrossN, lambda, out torque);
            ...
            if (connectionB.isDynamic)
            {
                ...
                Vector3.Mul(ref rBcrossN, lambda, out torque);
        ...
        public override void Update(float dt)
        {
            ...
            Vector3.Transform(ref localPointAnchor, ref connectionB.orientationMatrix, out rB);
            ...
            Vector3.Mul(ref worldPlaneNormal, distanceChange, out closestPointOnPlane);
            Vector3.Add(ref closestPointOnPlane, ref worldPointAnchor, out closestPointOnPlane);

            Vector3.Sub(ref closestPointOnPlane, ref connectionA.position, out rA);

            Vector3.Cross(ref rA, ref worldPlaneNormal, out rAcrossN);
            Vector3.Cross(ref rB, ref worldPlaneNormal, out rBcrossN);
            Vector3.Neg(ref rBcrossN, out rBcrossN);

            Vector3 offset;
            Vector3.Sub(ref worldPointAnchor, ref closestPointOnPlane, out offset);
            ...
            biasVelocity = MathUtilities.Clamp(-errorReduction * error, -maxCorrectiveVelocity, maxCorrectiveVelocity);

            if (connectionA.IsDynamic && connectionB.IsDynamic)
            {
                Vector3 IrACrossN, IrBCrossN;
                Vector3.Transform(ref rAcrossN, ref connectionA.inertiaTensorInverse, out IrACrossN);
                Vector3.Transform(ref rBcrossN, ref connectionB.inertiaTensorInverse, out IrBCrossN);
        ...
        public override void ExclusiveUpdate()
        {
            ...
            Vector3 impulse;
            Vector3 torque;
            Vector3.Mul(ref worldPlaneNormal, accumulatedImpulse, out impulse);
            if (connectionA.isDynamic)
            {
                Vector3.Mul(ref rAcrossN, accumulatedImpulse, out torque);
                connectionA.ApplyLinearImpulse(ref impulse);
                connectionA.ApplyAngularImpulse(ref torque);
            }
            if (connectionB.isDynamic)
            {
                Vector3.Neg(ref impulse, out impulse);
                Vector3.Mul(ref rBcrossN, accumulatedImpulse, out torque);
                connectionB.ApplyLinearImpulse(ref impulse);
                connectionB.ApplyAngularImpulse(ref torque);
            }
        }
