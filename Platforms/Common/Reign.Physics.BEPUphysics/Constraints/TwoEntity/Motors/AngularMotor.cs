    ...
    public class AngularMotor : Motor, I3DImpulseConstraintWithError, I3DJacobianConstraint
    {
        ...
        public override void Update(float dt)
        {
            ...
            if (settings.mode == MotorMode.Servomechanism) //Only need to do the bulk of this work if it's a servo.
            {
                ...
                //Matrix4 worldTransform = Matrix3x3.ToMatrix4x4(myBasis.worldTransform);
                //Quaternion basis;
				...
				var basisOrientation = Quaternion.FromMatrix3(basis.WorldTransform);
            ...
            else
            {
                ...
                Matrix3 transform = basis.WorldTransform;
                Vector3.Transform(ref settings.velocityMotor.goalVelocity, ref transform, out biasVelocity);
            }
