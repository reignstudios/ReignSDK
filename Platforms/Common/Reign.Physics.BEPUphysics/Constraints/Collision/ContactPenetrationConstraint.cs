...
namespace BEPUphysics.Constraints.Collision
{
    ...
    public class ContactPenetrationConstraint : EntitySolverUpdateable
    {
        ...
        public override void Update(float dt)
        {
            ...
            if (entityA != null)
            {
                Vector3.Sub(ref contact.Position, ref entityA.position, out ra);
            ...
            if (entityB != null)
            {
                Vector3.Sub(ref contact.Position, ref entityB.position, out rb);
            ...
            if (entityADynamic)
            {
                tX = angularAX * entityA.inertiaTensorInverse.X.X + angularAY * entityA.inertiaTensorInverse.Y.X + angularAZ * entityA.inertiaTensorInverse.Z.X;
                tY = angularAX * entityA.inertiaTensorInverse.X.Y + angularAY * entityA.inertiaTensorInverse.Y.Y + angularAZ * entityA.inertiaTensorInverse.Z.Y;
                tZ = angularAX * entityA.inertiaTensorInverse.X.Z + angularAY * entityA.inertiaTensorInverse.Y.Z + angularAZ * entityA.inertiaTensorInverse.Z.Z;
            ...
            if (entityBDynamic)
            {
                tX = angularBX * entityB.inertiaTensorInverse.X.X + angularBY * entityB.inertiaTensorInverse.Y.X + angularBZ * entityB.inertiaTensorInverse.Z.X;
                tY = angularBX * entityB.inertiaTensorInverse.X.Y + angularBY * entityB.inertiaTensorInverse.Y.Y + angularBZ * entityB.inertiaTensorInverse.Z.Y;
                tZ = angularBX * entityB.inertiaTensorInverse.X.Z + angularBY * entityB.inertiaTensorInverse.Y.Z + angularBZ * entityB.inertiaTensorInverse.Z.Z;
