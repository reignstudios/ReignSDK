...
namespace BEPUphysics.CollisionShapes.ConvexShapes
{
    ...
    public class SphereShape : ConvexShape
    {
        ...
        public override Matrix3 ComputeVolumeDistribution(out float volume)
        {
            ...
            volumeDistribution.X.X = diagValue;
            volumeDistribution.Y.Y = diagValue;
            volumeDistribution.Z.Z = diagValue;
        ...
        /// </summary>
        /// <param name="ray">Ray3 to test against the sphere.</param>
        ...
        public override bool RayTest(ref Ray3 ray, ref RigidTransform3 transform, float maximumLength, out RayHit hit)
        {
            ...
            //hit = new RayHit();
            //Vector3 m;
            //Vector3.Sub(ref ray.Position, ref transform.Position, out m);
            ...
            //Vector3.Sub(ref hit.Location, ref transform.Position, out hit.Normal);
