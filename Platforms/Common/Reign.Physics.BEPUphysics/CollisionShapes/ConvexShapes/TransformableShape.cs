...
namespace BEPUphysics.CollisionShapes.ConvexShapes
{
    ...
    public class TransformableShape : ConvexShape
    {
        ...
        public TransformableShape(ConvexShape shape, Matrix3 transform)
        {
            this.shape = shape;
            Transform = transform;
        ...
        {
            Vector3 d;
            Vector3.TransformTranspose(ref direction, ref transform, out d);
            shape.GetLocalExtremePoint(d, out extremePoint);
            Vector3.Transform(ref extremePoint, ref transform, out extremePoint);
        }
        ...
        public override float ComputeMaximumRadius()
        {
            ...
            Vector3 diameter;
            Vector3.Sub(ref boundingBox.Max, ref boundingBox.Min, out diameter);
