...
namespace BEPUphysics.CollisionShapes.ConvexShapes
{
    ...
    public struct ConvexShapeEntry
    {
        ...
        /// </summary>
        public RigidTransform3 Transform;
        ...
        {
            Transform = new RigidTransform3(position);
        ...
        {
            Transform = new RigidTransform3(orientation);
            CollisionShape = shape;
        }
        ...
        /// <param name="shape">Shape of the entry.</param>
        public ConvexShapeEntry(RigidTransform3 transform, ConvexShape shape)
        {
            Transform = transform;
            CollisionShape = shape;
        }
        ...
        {
            Transform = RigidTransform3.Identity;
            CollisionShape = shape;
        }
    }
    ///<summary>
    ...
    public class WrappedShape : ConvexShape
    {
        ...
        {
            RigidTransform3 subTransform;
            RigidTransform3.Transform(ref shapes.list.Elements[0].Transform, ref shapeTransform, out subTransform);
            shapes.list.Elements[0].CollisionShape.GetBoundingBox(ref subTransform, out boundingBox);
            for (int i = 1; i < shapes.list.count; i++)
            {
                RigidTransform3.Transform(ref shapes.list.Elements[i].Transform, ref shapeTransform, out subTransform);
                BoundingBox3 toMerge;
                shapes.list.Elements[i].CollisionShape.GetBoundingBox(ref subTransform, out toMerge);
                BoundingBox3.Merge(ref boundingBox, ref toMerge, out boundingBox);
            }
