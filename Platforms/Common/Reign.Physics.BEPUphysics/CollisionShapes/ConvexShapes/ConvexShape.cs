...
namespace BEPUphysics.CollisionShapes.ConvexShapes
{
    ...
    public abstract class ConvexShape : EntityShape
    {
        ...
        ///<param name="extremePoint">Extreme point on the shape.</param>
        public void GetExtremePointWithoutMargin(Vector3 direction, ref RigidTransform3 shapeTransform, out Vector3 extremePoint)
        {
        ...
        /// <param name="shapeTransform">Transform to use for the shape.</param>
        ///<param name="extremePoint">Extreme point on the shape.</param>
        public void GetExtremePoint(Vector3 direction, ref RigidTransform3 shapeTransform, out Vector3 extremePoint)
        {
            ...
            {
                Vector3.Mul(ref direction, collisionMargin / (float)Math.Sqrt(directionLength), out direction);
        ...
        public virtual void GetBoundingBox(ref RigidTransform3 shapeTransform, out BoundingBox3 boundingBox)
        {
            ...
            Vector3 right;
            var direction = new Vector3(o.X.X, o.Y.X, o.Z.X);
            GetLocalExtremePointWithoutMargin(ref direction, out right);

            Vector3 left;
            direction = new Vector3(-o.X.X, -o.Y.X, -o.Z.X);
            GetLocalExtremePointWithoutMargin(ref direction, out left);

            Vector3 up;
            direction = new Vector3(o.X.Y, o.Y.Y, o.Z.Y);
            ...
            Vector3 backward;
            direction = new Vector3(o.X.Z, o.Y.Z, o.Z.Z);
        ...
        /// <param name="hit">Ray3 hit data, if any.</param>
        /// <returns>Whether or not the ray hit the target.</returns>
        public virtual bool RayTest(ref Ray3 ray, ref RigidTransform3 transform, float maximumLength, out RayHit hit)
        {
            //TODO:
            //RayHit newHit;
        ...
        public override Matrix3 ComputeVolumeDistribution(out float volume)
        {
        ...
        /// </summary>
        /// <returns>Volume distribution of the shape.</returns>
        public override Matrix3 ComputeVolumeDistribution()
        {
            float volume;
        ...
        public void GetLocalBoundingBox(ref RigidTransform3 shapeTransform, ref AffineTransform3 spaceTransform, out BoundingBox3 boundingBox)
        {
            ...
            Vector3 right;
            var direction = new Vector3(transform.Transform.X.X, transform.Transform.Y.X, transform.Transform.Z.X);
            GetLocalExtremePoint(direction, out right);

            Vector3 left;
            direction = new Vector3(-transform.Transform.X.X, -transform.Transform.Y.X, -transform.Transform.Z.X);
            GetLocalExtremePoint(direction, out left);

            Vector3 up;
            direction = new Vector3(transform.Transform.X.Y, transform.Transform.Y.Y, transform.Transform.Z.Y);
            ...
            Vector3 backward;
            direction = new Vector3(transform.Transform.X.Z, transform.Transform.Y.Z, transform.Transform.Z.Z);
            ...
            Vector3.Transform(ref right, ref transform.Transform, out right);
            Vector3.Transform(ref left, ref transform.Transform, out left);
            Vector3.Transform(ref up, ref transform.Transform, out up);
            Vector3.Transform(ref down, ref transform.Transform, out down);
            Vector3.Transform(ref backward, ref transform.Transform, out backward);
            Vector3.Transform(ref forward, ref transform.Transform, out forward);
