...
namespace BEPUphysics.UpdateableSystems.ForceFields
{
    ...
    public class BoundingBoxForceFieldShape : ForceFieldShape
    {
        ...
        public BoundingBoxForceFieldShape(BoundingBox3 box)
        {
            BoundingBox3 = box;
        }
        ...
        /// </summary>
        public BoundingBox3 BoundingBox3 { get; set; }
        ...
        public override IList<Entity> GetPossiblyAffectedEntities()
        {
            ...
            ForceField.QueryAccelerator.GetEntries(BoundingBox3, affectedEntries);
