...
namespace BEPUphysics
{
    ...
    public interface ISpace
    {
        ...
        bool RayCast(Ray3 ray, out RayCastResult result);
        ...
        /// <param name="result">Hit data of the ray, if any.</param>
        /// <returns>Whether or not the ray hit anything.</returns>
        bool RayCast(Ray3 ray, Func<BroadPhaseEntry, bool> filter, out RayCastResult result);
        ...
        /// <param name="result">Hit data of the ray, if any.</param>
        /// <returns>Whether or not the ray hit anything.</returns>
        bool RayCast(Ray3 ray, float maximumLength, out RayCastResult result);
        ...
        /// <param name="result">Hit data of the ray, if any.</param>
        /// <returns>Whether or not the ray hit anything.</returns>
        bool RayCast(Ray3 ray, float maximumLength, Func<BroadPhaseEntry, bool> filter, out RayCastResult result);
        ...
        /// <returns>Whether or not the ray hit anything.</returns>
        bool RayCast(Ray3 ray, float maximumLength, IList<RayCastResult> outputRayCastResults);
        ...
        /// <param name="outputRayCastResults">Hit data of the ray, if any.</param>
        /// <returns>Whether or not the ray hit anything.</returns>
        bool RayCast(Ray3 ray, float maximumLength, Func<BroadPhaseEntry, bool> filter, IList<RayCastResult> outputRayCastResults);
    }
}
