...
namespace BEPUphysics.DataStructures
{
    ...
    public class TransformableMeshData : MeshBoundingBoxTreeData
    {
        ...
        public TransformableMeshData(Vector3[] vertices, int[] indices, AffineTransform3 worldTransform)
        {
        ...
        internal AffineTransform3 worldTransform = AffineTransform3.Identity;
        ...
        {
            Vector3.Transform(ref vertices[indices[triangleIndex]], ref worldTransform, out v1);
            Vector3.Transform(ref vertices[indices[triangleIndex + 1]], ref worldTransform, out v2);
            Vector3.Transform(ref vertices[indices[triangleIndex + 2]], ref worldTransform, out v3);
        }
        ...
        {
            Vector3.Transform(ref vertices[i], ref worldTransform, out vertex);
        }
