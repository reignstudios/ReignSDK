...
namespace BEPUphysics.DataStructures
{
    ...
    public class TriangleMesh
    {
        ...
        ///</summary>
        ///<param name="ray">Ray3 to test against the mesh.</param>
        ///<param name="hitCount">Number of hits between the ray and the mesh.</param>
        ///<returns>Whether or not the ray hit the mesh.</returns>
        public bool RayCast(Ray3 ray, out int hitCount)
        {
        ...
        ///<returns>Whether or not the ray hit the mesh.</returns>
        public bool RayCast(Ray3 ray, out RayHit rayHit)
        {
        ...
        ///<param name="rayHit">Hit data for the ray, if any.</param>
        ///<returns>Whether or not the ray hit the mesh.</returns>
        public bool RayCast(Ray3 ray, TriangleSidedness sidedness, out RayHit rayHit)
        {
        ...
        ///<returns>Whether or not the ray hit the mesh.</returns>
        public bool RayCast(Ray3 ray, IList<RayHit> hits)
        {
        ...
        ///<param name="hits">Hit data for the ray, if any.</param>
        ///<returns>Whether or not the ray hit the mesh.</returns>
        public bool RayCast(Ray3 ray, TriangleSidedness sidedness, IList<RayHit> hits)
        {
        ...
        ///<param name="rayHit">Hit data for the ray, if any.</param>
        ///<returns>Whether or not the ray hit the mesh.</returns>
        public bool RayCast(Ray3 ray, float maximumLength, out RayHit rayHit)
        {
        ...
        ///<param name="hits">Hit data for the ray, if any.</param>
        ///<returns>Whether or not the ray hit the mesh.</returns>
        public bool RayCast(Ray3 ray, float maximumLength, IList<RayHit> hits)
        {
        ...
        ///<param name="hits">Hit data for the ray, if any.</param>
        ///<returns>Whether or not the ray hit the mesh.</returns>
        public bool RayCast(Ray3 ray, float maximumLength, TriangleSidedness sidedness, IList<RayHit> hits)
        {
        ...
        public static void GetVerticesAndIndicesFromModel(Model collisionModel, out Vector3[] vertices, out int[] indices)
        {
            ...
            var transforms = new Matrix4[collisionModel.Bones.Count];
        ...
        public static void AddMesh(ModelMesh collisionModelMesh, Matrix4 transform, List<Vector3> vertices, IList<int> indices)
        {
