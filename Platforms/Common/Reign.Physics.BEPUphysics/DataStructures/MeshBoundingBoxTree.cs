...
{    
    ...
    public class MeshBoundingBoxTree
    {
        ...
        public bool GetOverlaps(BoundingBox3 boundingBox, IList<int> outputOverlappedElements)
        {
            if (root != null)
            {
                bool intersects;
        ...
        /// <param name="outputOverlappedElements">Indices of triangles in the index buffer with bounding boxes which are overlapped by the query.</param>
        /// <returns>Whether or not any elements were overlapped.</returns>
        public bool GetOverlaps(BoundingSphere3 boundingSphere, IList<int> outputOverlappedElements)
        {
            if (root != null)
            {
                bool intersects;
        ...
        /// <param name="outputOverlappedElements">Indices of triangles in the index buffer with bounding boxes which are overlapped by the query.</param>
        /// <returns>Whether or not any elements were overlapped.</returns>
        public bool GetOverlaps(BoundingFrustum3 boundingFrustum, IList<int> outputOverlappedElements)
        {
            if (root != null)
            {
                bool intersects;
        ...
        /// <param name="outputOverlappedElements">Indices of triangles in the index buffer with bounding boxes which are overlapped by the query.</param>
        /// <returns>Whether or not any elements were overlapped.</returns>
        public bool GetOverlaps(Ray3 ray, IList<int> outputOverlappedElements)
        {
            if (root != null)
            {
                float? result;
        ...
        /// <param name="outputOverlappedElements">Indices of triangles in the index buffer with bounding boxes which are overlapped by the query.</param>
        /// <returns>Whether or not any elements were overlapped.</returns>
        public bool GetOverlaps(Ray3 ray, float maximumLength, IList<int> outputOverlappedElements)
        {
            if (root != null)
            {
                float? result;
        ...
        abstract class Node
        {
            ...
            internal abstract void GetOverlaps(ref BoundingBox3 boundingBox, IList<int> outputOverlappedElements);
            internal abstract void GetOverlaps(ref BoundingSphere3 boundingSphere, IList<int> outputOverlappedElements);
            internal abstract void GetOverlaps(ref BoundingFrustum3 boundingFrustum, IList<int> outputOverlappedElements);
            internal abstract void GetOverlaps(ref Ray3 ray, float maximumLength, IList<int> outputOverlappedElements);
        ...
        sealed class InternalNode : Node
        {
            ...
            internal override void GetOverlaps(ref BoundingBox3 boundingBox, IList<int> outputOverlappedElements)
            {
            ...
            internal override void GetOverlaps(ref BoundingSphere3 boundingSphere, IList<int> outputOverlappedElements)
            {
                bool intersects;
            ...
            internal override void GetOverlaps(ref BoundingFrustum3 boundingFrustum, IList<int> outputOverlappedElements)
            {
                bool intersects;
            ...
            internal override void GetOverlaps(ref Ray3 ray, float maximumLength, IList<int> outputOverlappedElements)
            {
                float? result;
