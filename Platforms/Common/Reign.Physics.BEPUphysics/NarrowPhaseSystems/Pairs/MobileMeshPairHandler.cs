...
namespace BEPUphysics.NarrowPhaseSystems.Pairs
{
    ...
    public abstract class MobileMeshPairHandler : StandardPairHandler
    {
        ...
        public override void UpdateTimeOfImpact(Collidable requester, float dt)
        {
                ...
                )
            {
                ...
                {                    
                    ...
                    Vector3.Neg(ref mobileMesh.entity.linearVelocity, out velocity);
                }
                ...
                else
                {
                    ...
                    Vector3.Sub(ref convex.entity.linearVelocity, ref mobileMesh.entity.linearVelocity, out velocity);

                }
                Vector3.Mul(ref velocity, dt, out velocity);
                ...
                if (minimumRadius * minimumRadius < velocitySquared)
                {
                    ...
                    Matrix3 orientation;
                    Matrix3.FromQuaternion(ref mobileMesh.worldTransform.Orientation, out orientation);
                    ...
                    for (int i = 0; i < MeshManifold.overlappedTriangles.count; i++)
                    {
                        ...
                        Vector3.Transform(ref triangle.vA, ref orientation, out triangle.vA);
                        Vector3.Transform(ref triangle.vB, ref orientation, out triangle.vB);
                        Vector3.Transform(ref triangle.vC, ref orientation, out triangle.vC);
                        ...
                        Vector3.Sub(ref triangle.vA, ref convex.worldTransform.Position, out triangle.vA);
                        Vector3.Sub(ref triangle.vB, ref convex.worldTransform.Position, out triangle.vB);
                        Vector3.Sub(ref triangle.vC, ref convex.worldTransform.Position, out triangle.vC);

                        RayHit rayHit;
                        if (GJKToolbox.CCDSphereCast(new Ray3(Toolbox.ZeroVector, velocity), minimumRadius, triangle, ref Toolbox.RigidIdentity, timeOfImpact, out rayHit) &&
        ...
        protected internal override void GetContactInformation(int index, out ContactInformation info)
        {
            ...
            {
                Vector3.Sub(ref info.Contact.Position, ref convex.entity.position, out velocity);
            ...
            {
                Vector3.Sub(ref info.Contact.Position, ref mobileMesh.entity.position, out velocity);
                ...
                Vector3.Sub(ref info.RelativeVelocity, ref velocity, out info.RelativeVelocity);
            }
