...
namespace BEPUphysics.NarrowPhaseSystems.Pairs
{
    ...
    public class MobileMeshInstancedMeshPairHandler : MobileMeshMeshPairHandler
    {
        ...
        protected override TriangleCollidable GetOpposingCollidable(int index)
        {
            ...
            Vector3.Transform(ref shape.vA, ref mesh.worldTransform.Transform, out shape.vA);
            Vector3.Transform(ref shape.vB, ref mesh.worldTransform.Transform, out shape.vB);
            Vector3.Transform(ref shape.vC, ref mesh.worldTransform.Transform, out shape.vC);
            Vector3 center;
        ...
        protected override void UpdateContainedPairs(float dt)
        {
            ...
            Vector3 sweep;
            Vector3.Mul(ref mobileMesh.entity.linearVelocity, dt, out sweep);
