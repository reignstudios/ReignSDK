    ...
    public abstract class InstancedMeshPairHandler : StandardPairHandler
    {
        ...
        public override void UpdateTimeOfImpact(Collidable requester, float dt)
        {
            ...
            if (convex.IsActive && convex.entity.PositionUpdateMode == PositionUpdateMode.Continuous)
            {
                ...
                Vector3 velocity;
                Vector3.Mul(ref convex.entity.linearVelocity, dt, out velocity);
                ...
                if (minimumRadius * minimumRadius < velocitySquared)
                {
                    ...
                    for (int i = 0; i < MeshManifold.overlappedTriangles.count; i++)
                    {
                        ...
                        Vector3.Transform(ref triangle.vA, ref instancedMesh.worldTransform, out triangle.vA);
                        Vector3.Transform(ref triangle.vB, ref instancedMesh.worldTransform, out triangle.vB);
                        Vector3.Transform(ref triangle.vC, ref instancedMesh.worldTransform, out triangle.vC);
