...
namespace BEPUphysics.NarrowPhaseSystems.Pairs
{
    ...
    public class MobileMeshMobileMeshPairHandler : MobileMeshMeshPairHandler
    {
        ...
        protected override void ConfigureCollidable(TriangleEntry entry, float dt)
        {
            ...
            Matrix3 o;
            Matrix3.FromQuaternion(ref mesh.worldTransform.Orientation, out o);
            Vector3.Transform(ref shape.vA, ref o, out shape.vA);
            Vector3.Transform(ref shape.vB, ref o, out shape.vB);
            Vector3.Transform(ref shape.vC, ref o, out shape.vC);
            Vector3 center;
            Vector3.Add(ref shape.vA, ref shape.vB, out center);
            Vector3.Add(ref center, ref shape.vC, out center);
            Vector3.Mul(ref center, 1 / 3f, out center);
            Vector3.Sub(ref shape.vA, ref center, out shape.vA);
            Vector3.Sub(ref shape.vB, ref center, out shape.vB);
            Vector3.Sub(ref shape.vC, ref center, out shape.vC);
        ...
        protected override void UpdateContainedPairs(float dt)
        {
            ...
            AffineTransform3 meshTransform;
            AffineTransform3.FromRigidTransform(ref mesh.worldTransform, out meshTransform);

            Vector3 sweep;
            Vector3.Sub(ref mobileMesh.entity.linearVelocity, ref mesh.entity.linearVelocity, out sweep);
            Vector3.Mul(ref sweep, dt, out sweep);
