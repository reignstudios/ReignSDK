...
namespace BEPUphysics.NarrowPhaseSystems.Pairs
{
    ...
    public class MobileMeshTerrainPairHandler : MobileMeshMeshPairHandler
    {
        ...
        protected override TriangleCollidable GetOpposingCollidable(int index)
        {
            ...
            Vector3 terrainUp = new Vector3(mesh.worldTransform.Transform.Y.X, mesh.worldTransform.Transform.Y.Y, mesh.worldTransform.Transform.Y.Z);
            float dot;
            ...
            Vector3.Sub(ref shape.vB, ref shape.vA, out AB);
            Vector3.Sub(ref shape.vC, ref shape.vA, out AC);
