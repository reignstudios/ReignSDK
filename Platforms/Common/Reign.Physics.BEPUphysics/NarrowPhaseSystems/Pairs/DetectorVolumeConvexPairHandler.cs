...
namespace BEPUphysics.NarrowPhaseSystems.Pairs
{
    ...
    public class DetectorVolumeConvexPairHandler : DetectorVolumePairHandler
    {
        ...
        public override void UpdateCollision(float dt)
        {
            ...
            var transform = new RigidTransform3 { Orientation = Quaternion.Identity };
            ...
            for (int i = 0; i < overlaps.count; i++)
            {
                ...
                Vector3.Mul(ref transform.Position, 1 / 3f, out transform.Position);
                Vector3.Sub(ref triangle.vA, ref transform.Position, out triangle.vA);
                Vector3.Sub(ref triangle.vB, ref transform.Position, out triangle.vB);
                Vector3.Sub(ref triangle.vC, ref transform.Position, out triangle.vC);
