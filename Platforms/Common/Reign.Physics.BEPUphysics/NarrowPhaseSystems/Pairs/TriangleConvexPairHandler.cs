        ...
        public override void UpdateTimeOfImpact(Collidable requester, float dt)
        {
                ...
                )
            {
                ...
                else if (triangleMode == PositionUpdateMode.Discrete)
                {
                    ...
                    Vector3.Neg(ref convex.entity.linearVelocity, out velocity);
                }
                else
                {
                    //Both objects are moving.
                    Vector3.Sub(ref triangle.entity.linearVelocity, ref convex.entity.linearVelocity, out velocity);
                }
                ...
                if (minimumRadiusA * minimumRadiusA < velocitySquared)
                {
                    ...
                    RayHit rayHit;
                    if (GJKToolbox.CCDSphereCast(new Ray3(convex.worldTransform.Position, -velocity), minimumRadiusA, triangle.Shape, ref triangle.worldTransform, timeOfImpact, out rayHit))
                    {
                        ...
                        {                
                            ...
                            Vector3 AB, AC;
                            Vector3.Sub(ref triangle.Shape.vB, ref triangle.Shape.vA, out AB);
                            Vector3.Sub(ref triangle.Shape.vC, ref triangle.Shape.vA, out AC);
                            Vector3 normal;
                ...
                //    RayHit rayHit;
                //    if (GJKToolbox.SphereCast(new Ray3(triangle.entity.position, velocity), minimumRadiusB, convex.Shape, ref convex.worldTransform, 1, out rayHit) &&
