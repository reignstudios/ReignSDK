...
namespace BEPUphysics.NarrowPhaseSystems.Pairs
{
    ...
    public class DetectorVolumeMobileMeshPairHandler : DetectorVolumePairHandler
    {
        ...
        public override void UpdateCollision(float dt)
        {
            ...
            RigidTransform3 mobileTriangleTransform, detectorTriangleTransform;
            ...
            for (int i = 0; i < meshData.Indices.Length; i += 3)
            {
                ...
                Vector3.Transform(ref mobileTriangle.vA, ref mesh.worldTransform, out mobileTriangle.vA);
                Vector3.Transform(ref mobileTriangle.vB, ref mesh.worldTransform, out mobileTriangle.vB);
                Vector3.Transform(ref mobileTriangle.vC, ref mesh.worldTransform, out mobileTriangle.vC);
                ...
                Vector3.Mul(ref mobileTriangleTransform.Position, 1 / 3f, out mobileTriangleTransform.Position);
                Vector3.Sub(ref mobileTriangle.vA, ref mobileTriangleTransform.Position, out mobileTriangle.vA);
                Vector3.Sub(ref mobileTriangle.vB, ref mobileTriangleTransform.Position, out mobileTriangle.vB);
                Vector3.Sub(ref mobileTriangle.vC, ref mobileTriangleTransform.Position, out mobileTriangle.vC);
                ...
                BoundingBox3 mobileBoundingBox;
                ...
                for (int j = 0; j < overlaps.count; j++)
                {
                    ...
                    Vector3.Mul(ref detectorTriangleTransform.Position, 1 / 3f, out detectorTriangleTransform.Position);
                    Vector3.Sub(ref detectorTriangle.vA, ref detectorTriangleTransform.Position, out detectorTriangle.vA);
                    Vector3.Sub(ref detectorTriangle.vB, ref detectorTriangleTransform.Position, out detectorTriangle.vB);
                    Vector3.Sub(ref detectorTriangle.vC, ref detectorTriangleTransform.Position, out detectorTriangle.vC);
            ...
            if (mesh.Shape.solidity == MobileMeshSolidity.Solid && !Containing && !Touching)
            {
                ...
                RayHit hit;
                Vector3.TransformInversed(ref vertex, ref mesh.worldTransform, out ray.Position);
