...
namespace BEPUphysics
{
    ...
    public class Space : ISpace, IDisposable
    {
        ...
        public bool RayCast(Ray3 ray, out RayCastResult result)
        {
        ...
        /// <param name="result">Hit data of the ray, if any.</param>
        /// <returns>Whether or not the ray hit anything.</returns>
        public bool RayCast(Ray3 ray, Func<BroadPhaseEntry, bool> filter, out RayCastResult result)
        {
        ...
        /// <param name="result">Hit data of the ray, if any.</param>
        /// <returns>Whether or not the ray hit anything.</returns>
        public bool RayCast(Ray3 ray, float maximumLength, out RayCastResult result)
        {
        ...
        /// <param name="result">Hit data of the ray, if any.</param>
        /// <returns>Whether or not the ray hit anything.</returns>
        public bool RayCast(Ray3 ray, float maximumLength, Func<BroadPhaseEntry, bool> filter, out RayCastResult result)
        {
            var resultsList = Resources.GetRayCastResultList();
        ...
        /// <returns>Whether or not the ray hit anything.</returns>
        public bool RayCast(Ray3 ray, float maximumLength, IList<RayCastResult> outputRayCastResults)
        {
        ...
        /// <param name="outputRayCastResults">Hit data of the ray, if any.</param>
        /// <returns>Whether or not the ray hit anything.</returns>
        public bool RayCast(Ray3 ray, float maximumLength, Func<BroadPhaseEntry, bool> filter, IList<RayCastResult> outputRayCastResults)
        {
            var outputIntersections = Resources.GetBroadPhaseEntryList();
            if (BroadPhase.QueryAccelerator.RayCast(ray, maximumLength, outputIntersections))
            {
