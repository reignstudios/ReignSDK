...
namespace BEPUphysics.Collidables
{
    ...
    public class DetectorVolume : BroadPhaseEntry, ISpaceObject, IDeferredEventCreator
    {
        ...
        internal bool IsPointContained(ref Vector3 point, RawList<int> triangles)
        {
            ...
            Vector3.Mul(ref rayDirection, .5f, out rayDirection);
            Vector3.Sub(ref point, ref rayDirection, out rayDirection);
            //If the point is right in the middle, we'll need a backup.
            if (rayDirection.LengthSquared() < .01f)
                rayDirection = Vector3.Up;

            var ray = new Ray3(point, rayDirection);
        ...
        {
            boundingBox = triangleMesh.Tree.BoundingBox3;
        }
        ...
        public void Reinitialize()
        {
            ...
            Vector3 origin = (triangleMesh.Tree.BoundingBox3.Max - triangleMesh.Tree.BoundingBox3.Min) * 1.5f + triangleMesh.Tree.BoundingBox3.Min;
            ...
            var ray = new Ray3(origin, direction);
            var triangles = Resources.GetIntList();
            triangleMesh.Tree.GetOverlaps(ray, triangles);
