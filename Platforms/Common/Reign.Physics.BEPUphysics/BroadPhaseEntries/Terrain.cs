    ...
    public class Terrain : StaticCollidable
    {
        ...
        public float Thickness
        {
            ...
            set
            {
                ...
                Vector3 down = worldTransform.Transform.Down.Normalize();
        ...
        public Terrain(TerrainShape shape, AffineTransform3 worldTransform)
        {
        ...
        ///<param name="worldTransform">Transform to use for the terrain.</param>
        public Terrain(float[,] heights, AffineTransform3 worldTransform)
        ...
        public override void UpdateBoundingBox()
        {
            ...
            Vector3 thicknessOffset = worldTransform.Transform.Down.Normalize() * thickness;
