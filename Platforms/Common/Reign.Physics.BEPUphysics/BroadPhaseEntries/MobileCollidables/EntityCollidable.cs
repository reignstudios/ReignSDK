...
namespace BEPUphysics.Collidables.MobileCollidables
{
    ...
    public abstract class EntityCollidable : MobileCollidable
    {
        ...
        protected internal RigidTransform3 worldTransform;
        ///<summary>
        ...
        ///</summary>
        public RigidTransform3 WorldTransform
        {
            get
            {
            ...
            set
            {
                ...
                Vector3.Sub(ref value.Position, ref worldOffset, out value.Position);
        ...
        public void UpdateBoundingBoxForTransform(ref RigidTransform3 transform, float dt)
        {
        ...
        /// </summary>
        /// <param name="transform">Transform to use for the collidable.</param>
        public void UpdateBoundingBoxForTransform(ref RigidTransform3 transform)
        {
        ...
        internal void ExpandBoundingBox(ref BoundingBox3 boundingBox, float dt)
        {
