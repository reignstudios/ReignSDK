...
namespace BEPUphysics.BroadPhaseEntries
{
    ...
    public abstract class BroadPhaseEntry : IBoundingBoxOwner, ICollisionRulesOwner
    {
        ...
        protected internal BoundingBox3 boundingBox;
        /// <summary>
        ...
        public abstract bool RayCast(Ray3 ray, float maximumLength, out RayHit rayHit);
        ...
        /// <param name="rayHit">Hit location of the ray on the entry, if any.</param>
        /// <returns>Whether or not the ray hit the entry.</returns>
        public virtual bool RayCast(Ray3 ray, float maximumLength, Func<BroadPhaseEntry, bool> filter, out RayHit rayHit)
        {
            if (filter(this))
        ...
        /// <returns>Whether or not the ray hit the entry.</returns>
        public abstract bool ConvexCast(ConvexShape castShape, ref RigidTransform3 startingTransform, ref Vector3 sweep, out RayHit hit);
