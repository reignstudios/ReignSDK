                                                   ...
                                                   ref Vector3 otherPoint, out RaySimplex simplex, out Vector3 point)
        {
            ...
            if (AdotN * ADdotN >= 0)
            {
                ...
                if (va <= 0f && (d3d4 = BdotAC - BdotAB) > 0f && (d6d5 = CdotAB - CdotAC) > 0f)//Note > instead of >= and < instead of <=; prevents bad denominator
                {
                    ...
                    Vector3 bc;
                    Vector3.Sub(ref C, ref B, out bc);
                    Vector3.Mul(ref bc, V, out point);
                    Vector3.Add(ref point, ref B, out point);
                    return true;
                }
        ...
        public void AddNewSimplexPoint(ref Vector3 point, ref Vector3 hitLocation, out RaySimplex shiftedSimplex)
        {
            ...
            switch (State)
            {
                case SimplexState.Empty:
                    ...
                    Vector3.Sub(ref hitLocation, ref A, out shiftedSimplex.A);
                    break;
                case SimplexState.Point:
                    ...
                    Vector3.Sub(ref hitLocation, ref A, out shiftedSimplex.A);
                    Vector3.Sub(ref hitLocation, ref B, out shiftedSimplex.B);
                    break;
                case SimplexState.Segment:
                    ...
                    Vector3.Sub(ref hitLocation, ref A, out shiftedSimplex.A);
                    Vector3.Sub(ref hitLocation, ref B, out shiftedSimplex.B);
                    Vector3.Sub(ref hitLocation, ref C, out shiftedSimplex.C);
                    break;
                case SimplexState.Triangle:
                    ...
                    Vector3.Sub(ref hitLocation, ref B, out shiftedSimplex.B);
                    Vector3.Sub(ref hitLocation, ref C, out shiftedSimplex.C);
                    Vector3.Sub(ref hitLocation, ref D, out shiftedSimplex.D);
                    break;
            }
