...
namespace BEPUphysics.CollisionTests.CollisionAlgorithms.GJK
{
    ...
    {
        //public CachedSimplex(ConvexShape shapeA, ConvexShape shapeB, ref RigidTransform3 transformA, ref RigidTransform3 transformB)
        //{
        ...
        //    Vector3 direction;
        //    Vector3.Neg(ref localTransformB.Position, out direction);
        ...
        //public CachedSimplex(ConvexShape shapeA, ConvexShape shapeB, ref RigidTransform3 localTransformB)
        //{
        //    LocalSimplexA = new ContributingShapeSimplex();
        //    LocalSimplexB = new ContributingShapeSimplex();
    ...
    public struct PairSimplex
    {
        ...
        /// </summary>
        public RigidTransform3 LocalTransformB;


        private PairSimplex(ref RigidTransform3 localTransformB)
        {
            ...
            Vector3.Neg(ref localTransformB.Position, out A);
            B = new Vector3();
            C = new Vector3();
            D = new Vector3();
            U = 0;
        ...
        public PairSimplex(ref CachedSimplex cachedSimplex, ref RigidTransform3 localTransformB)
        {
            //NOTE:
            ...
            switch (State)
            {
                case SimplexState.Point:
                    ...
                    Vector3.Sub(ref SimplexA.A, ref SimplexB.A, out A);
                    B = new Vector3();
                    C = new Vector3();
                    D = new Vector3();
                    break;
                case SimplexState.Segment:
                    Matrix3 transform;
                    Matrix3.FromQuaternion(ref localTransformB.Orientation, out transform);
                    Vector3.Transform(ref cachedSimplex.LocalSimplexB.A, ref transform, out SimplexB.A);
                    Vector3.Transform(ref cachedSimplex.LocalSimplexB.B, ref transform, out SimplexB.B);
                    Vector3.Add(ref SimplexB.A, ref LocalTransformB.Position, out SimplexB.A);
                    Vector3.Add(ref SimplexB.B, ref LocalTransformB.Position, out SimplexB.B);

                    Vector3.Sub(ref SimplexA.A, ref SimplexB.A, out A);
                    Vector3.Sub(ref SimplexA.B, ref SimplexB.B, out B);
                    C = new Vector3();
                    D = new Vector3();
                ...
                case SimplexState.Triangle:
                    ...
                    Vector3.Transform(ref cachedSimplex.LocalSimplexB.A, ref transform, out SimplexB.A);
                    Vector3.Transform(ref cachedSimplex.LocalSimplexB.B, ref transform, out SimplexB.B);
                    Vector3.Transform(ref cachedSimplex.LocalSimplexB.C, ref transform, out SimplexB.C);
                    Vector3.Add(ref SimplexB.A, ref LocalTransformB.Position, out SimplexB.A);
                    Vector3.Add(ref SimplexB.B, ref LocalTransformB.Position, out SimplexB.B);
                    ...
                    Vector3.Sub(ref SimplexA.A, ref SimplexB.A, out A);
                    Vector3.Sub(ref SimplexA.B, ref SimplexB.B, out B);
                    Vector3.Sub(ref SimplexA.C, ref SimplexB.C, out C);
                    D = new Vector3();
                ...
                case SimplexState.Tetrahedron:
                    ...
                    Vector3.Transform(ref cachedSimplex.LocalSimplexB.B, ref transform, out SimplexB.B);
                    Vector3.Transform(ref cachedSimplex.LocalSimplexB.C, ref transform, out SimplexB.C);
                    Vector3.Transform(ref cachedSimplex.LocalSimplexB.D, ref transform, out SimplexB.D);
                    Vector3.Add(ref SimplexB.A, ref LocalTransformB.Position, out SimplexB.A);
                    Vector3.Add(ref SimplexB.B, ref LocalTransformB.Position, out SimplexB.B);
                    Vector3.Add(ref SimplexB.C, ref LocalTransformB.Position, out SimplexB.C);
                    ...
                    Vector3.Sub(ref SimplexA.B, ref SimplexB.B, out B);
                    Vector3.Sub(ref SimplexA.C, ref SimplexB.C, out C);
                    Vector3.Sub(ref SimplexA.D, ref SimplexB.D, out D);

                    ////Test for degeneracy.
                    //Vector3 AD;
                    //Vector3.Sub(ref B, ref A, out AB);
                    //Vector3.Sub(ref C, ref A, out AC);
                    //Vector3.Sub(ref D, ref A, out AD);
                    //Vector3.Cross(ref AB, ref AC, out cross);
                    //float volume;
        ...
        public void UpdateCachedSimplex(ref CachedSimplex simplex)
        {
            ...
            {
                case SimplexState.Point:
                    Vector3.Sub(ref SimplexB.A, ref LocalTransformB.Position, out simplex.LocalSimplexB.A);
                    Quaternion conjugate;
                    Quaternion.Conjugate(ref LocalTransformB.Orientation, out conjugate);
                ...
                case SimplexState.Segment:
                    Vector3.Sub(ref SimplexB.A, ref LocalTransformB.Position, out simplex.LocalSimplexB.A);
                    Vector3.Sub(ref SimplexB.B, ref LocalTransformB.Position, out simplex.LocalSimplexB.B);

                    Matrix3 transform;
                    Matrix3.FromQuaternion(ref LocalTransformB.Orientation, out transform);
                    Vector3.TransformTranspose(ref simplex.LocalSimplexB.A, ref transform, out simplex.LocalSimplexB.A);
                    Vector3.TransformTranspose(ref simplex.LocalSimplexB.B, ref transform, out simplex.LocalSimplexB.B);
                    break;
                case SimplexState.Triangle:
                    Vector3.Sub(ref SimplexB.A, ref LocalTransformB.Position, out simplex.LocalSimplexB.A);
                    Vector3.Sub(ref SimplexB.B, ref LocalTransformB.Position, out simplex.LocalSimplexB.B);
                    Vector3.Sub(ref SimplexB.C, ref LocalTransformB.Position, out simplex.LocalSimplexB.C);

                    Matrix3.FromQuaternion(ref LocalTransformB.Orientation, out transform);
                    Vector3.TransformTranspose(ref simplex.LocalSimplexB.A, ref transform, out simplex.LocalSimplexB.A);
                    Vector3.TransformTranspose(ref simplex.LocalSimplexB.B, ref transform, out simplex.LocalSimplexB.B);
                    Vector3.TransformTranspose(ref simplex.LocalSimplexB.C, ref transform, out simplex.LocalSimplexB.C);
                    break;
                case SimplexState.Tetrahedron:
                    Vector3.Sub(ref SimplexB.A, ref LocalTransformB.Position, out simplex.LocalSimplexB.A);
                    Vector3.Sub(ref SimplexB.B, ref LocalTransformB.Position, out simplex.LocalSimplexB.B);
                    Vector3.Sub(ref SimplexB.C, ref LocalTransformB.Position, out simplex.LocalSimplexB.C);
                    Vector3.Sub(ref SimplexB.D, ref LocalTransformB.Position, out simplex.LocalSimplexB.D);

                    Matrix3.FromQuaternion(ref LocalTransformB.Orientation, out transform);
                    Vector3.TransformTranspose(ref simplex.LocalSimplexB.A, ref transform, out simplex.LocalSimplexB.A);
                    Vector3.TransformTranspose(ref simplex.LocalSimplexB.B, ref transform, out simplex.LocalSimplexB.B);
                    Vector3.TransformTranspose(ref simplex.LocalSimplexB.C, ref transform, out simplex.LocalSimplexB.C);
                    Vector3.TransformTranspose(ref simplex.LocalSimplexB.D, ref transform, out simplex.LocalSimplexB.D);
                    break;
            }
            simplex.State = State;
        }
        ...
        public void GetPointOnSegmentClosestToOrigin(out Vector3 point)
        {
            ...
            Vector3.Sub(ref B, ref A, out segmentDisplacement);
            ...
            if (dotB > 0)
            {
                ...
                V = 1 - U;
                Vector3.Mul(ref segmentDisplacement, V, out point);
        ...
        public void GetPointOnTriangleClosestToOrigin(out Vector3 point)
        {
            ...
            if (vc <= 0 && AdotAB > 0 && BdotAB < 0)//Note > and < instead of => <=; avoids possibly division by zero
            {
                ...
                Vector3.Mul(ref ab, V, out point);
                Vector3.Add(ref point, ref A, out point);
                return;
            }
            ...
            if (vb <= 0f && AdotAC > 0f && CdotAC < 0f)//Note > instead of >= and < instead of <=; prevents bad denominator
            {
                ...
                U = 1 - V;
                Vector3.Mul(ref ac, V, out point);
                Vector3.Add(ref point, ref A, out point);
                return;
            }
            ...
            if (va <= 0f && (d3d4 = BdotAC - BdotAB) > 0f && (d6d5 = CdotAB - CdotAC) > 0f)//Note > instead of >= and < instead of <=; prevents bad denominator
            {
                ...
                Vector3 bc;
                Vector3.Sub(ref C, ref B, out bc);
                Vector3.Mul(ref bc, U, out point);
                                                   ...
                                                   ref Vector3 otherPoint, out PairSimplex simplex, out Vector3 point)
        {
            ...
            float AdotN, ADdotN;
            Vector3 AD;
            Vector3.Sub(ref otherPoint, ref A, out AD);
            ...
            if (AdotN * ADdotN >= -Toolbox.Epsilon * errorTolerance)
            {
                ...
                if (vc <= 0 && AdotAB > 0 && BdotAB < 0) //Note > and < instead of => <=; avoids possibly division by zero
                {
                    ...
                    Vector3.Mul(ref ab, simplex.V, out point);
                    Vector3.Add(ref point, ref A, out point);
                    return true;
                }
                ...
                if (vb <= 0f && AdotAC > 0f && CdotAC < 0f) //Note > instead of >= and < instead of <=; prevents bad denominator
                {
                    ...
                    simplex.U = 1 - simplex.V;
                    Vector3.Mul(ref ac, simplex.V, out point);
                    Vector3.Add(ref point, ref A, out point);
                    return true;
                }
                ...
                if (va <= 0f && (d3d4 = BdotAC - BdotAB) > 0f && (d6d5 = CdotAB - CdotAC) > 0f)//Note > instead of >= and < instead of <=; prevents bad denominator
                {
                    ...
                    Vector3 bc;
                    Vector3.Sub(ref C, ref B, out bc);
                    Vector3.Mul(ref bc, simplex.V, out point);
                    Vector3.Add(ref point, ref B, out point);
                    return true;
                }
                ...
                Vector3.Mul(ref ab, simplex.V, out point);
                Vector3 acw;
                Vector3.Mul(ref ac, simplex.W, out acw);
                Vector3.Add(ref A, ref point, out point);
                Vector3.Add(ref point, ref acw, out point);
                return true;
            }
        ...
        public bool GetNewSimplexPoint(ConvexShape shapeA, ConvexShape shapeB, int iterationCount, ref Vector3 closestPoint)
        {
            ...
            Vector3.Neg(ref closestPoint, out negativeDirection);
            Vector3 sa, sb;
            ...
            Vector3 S;
            Vector3.Sub(ref sa, ref sb, out S);
            ...
            {
                case SimplexState.Point:
                    if (progression <= (errorTolerance = Math.Max(A.LengthSquared(), S.LengthSquared())) * ProgressionEpsilon)
                        return true;
                    ...
                    return false;
                case SimplexState.Segment:
                    if (progression <= (errorTolerance = Math.Max(Math.Max(A.LengthSquared(), B.LengthSquared()), S.LengthSquared())) * ProgressionEpsilon)
                        return true;
                    ...
                    return false;
                case SimplexState.Triangle:
                    if (progression <= (errorTolerance = Math.Max(Math.Max(A.LengthSquared(), B.LengthSquared()), Math.Max(C.LengthSquared(), S.LengthSquared()))) * ProgressionEpsilon)
                        return true;
        ...
        public void GetClosestPoints(out Vector3 closestPointA, out Vector3 closestPointB)
        {
            ...
            switch (State)
            {
                ...
                case SimplexState.Segment:
                    Vector3 temp;
                    Vector3.Mul(ref SimplexA.A, U, out closestPointA);
                    Vector3.Mul(ref SimplexA.B, V, out temp);
                    Vector3.Add(ref closestPointA, ref temp, out closestPointA);

                    Vector3.Mul(ref SimplexB.A, U, out closestPointB);
                    Vector3.Mul(ref SimplexB.B, V, out temp);
                ...
                case SimplexState.Triangle:
                    ...
                    Vector3.Mul(ref SimplexA.B, V, out temp);
                    Vector3.Add(ref closestPointA, ref temp, out closestPointA);
                    Vector3.Mul(ref SimplexA.C, W, out temp);
                    Vector3.Add(ref closestPointA, ref temp, out closestPointA);

                    Vector3.Mul(ref SimplexB.A, U, out closestPointB);
                    Vector3.Mul(ref SimplexB.B, V, out temp);
                    Vector3.Add(ref closestPointB, ref temp, out closestPointB);
                    Vector3.Mul(ref SimplexB.C, W, out temp);
                    Vector3.Add(ref closestPointB, ref temp, out closestPointB);
                    return;
            }
        ...
        internal void VerifyContributions()
        {
            ...
            {
                case SimplexState.Point:
                    if ((SimplexA.A - SimplexB.A).Distance(A) > .0001f)
                        DebugS.WriteLine("break.");
                    break;
                case SimplexState.Segment:
                    if ((SimplexA.A - SimplexB.A).Distance(A) > .0001f)
                        DebugS.WriteLine("break.");

                    if ((SimplexA.B - SimplexB.B).Distance(B) > .0001f)
                        DebugS.WriteLine("break.");
                    break;
                case SimplexState.Triangle:
                    if ((SimplexA.A - SimplexB.A).Distance(A) > .0001f)
                    ...
                    if ((SimplexA.C - SimplexB.C).Distance(C) > .0001f)
                        DebugS.WriteLine("break.");
                    break;
                ...
                case SimplexState.Tetrahedron:
                    ...
                    if ((SimplexA.D - SimplexB.D).Distance(D) > .0001f)
                        DebugS.WriteLine("break.");
                    break;
            }
        }
