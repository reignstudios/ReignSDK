...
namespace BEPUphysics.CollisionTests.CollisionAlgorithms
{
    ...
    public static class MinkowskiToolbox
    {
        ...
        public static void GetLocalTransform(ref RigidTransform3 transformA, ref RigidTransform3 transformB,
                                             out RigidTransform3 localTransformB)
        {
        ...
        public static void GetLocalMinkowskiExtremePoint(ConvexShape shapeA, ConvexShape shapeB, ref Vector3 direction, ref RigidTransform3 localTransformB, out Vector3 extremePoint)
        {
            ...
            Vector3 v;
            Vector3 negativeN;
            Vector3.Neg(ref direction, out negativeN);
            shapeB.GetExtremePointWithoutMargin(negativeN, ref localTransformB, out v);
            Vector3.Sub(ref extremePoint, ref v, out extremePoint);
        ...
        ///<param name="extremePoint">The extreme point in the local space of A.</param>
        public static void GetLocalMinkowskiExtremePoint(ConvexShape shapeA, ConvexShape shapeB, ref Vector3 direction, ref RigidTransform3 localTransformB,
                                                 out Vector3 extremePointA, out Vector3 extremePoint)
        {
            ...
            Vector3 v;
            Vector3.Neg(ref direction, out v);
            ...
            Vector3.Sub(ref extremePointA, ref extremePointB, out extremePoint);
        ...
        ///<param name="localTransformB">Transform of shapeB in the local space of A.</param>
        ///<param name="extremePoint">The extreme point in the local space of A.</param>
        public static void GetLocalMinkowskiExtremePointWithoutMargin(ConvexShape shapeA, ConvexShape shapeB, ref Vector3 direction, ref RigidTransform3 localTransformB, out Vector3 extremePoint)
        {
            //Extreme point of A-B along D = (extreme point of A along D) - (extreme point of B along -D)
            shapeA.GetLocalExtremePointWithoutMargin(ref direction, out extremePoint);
            Vector3 extremePointB;
            ...
            Vector3.Sub(ref extremePoint, ref extremePointB, out extremePoint);
        ...
        public static void ExpandMinkowskiSum(float marginA, float marginB, ref Vector3 direction, out Vector3 contribution)
        {
            ...
            if (lengthSquared > Toolbox.Epsilon)
            {
                ...
                Vector3.Mul(ref direction, (marginA + marginB) / (float)Math.Sqrt(lengthSquared), out contribution);
        ...
        public static void ExpandMinkowskiSum(float marginA, float marginB, Vector3 direction, ref Vector3 toExpandA, ref Vector3 toExpandB)
        {
            ...
            if (lengthSquared > Toolbox.Epsilon)
            {
                ...
                Vector3.Mul(ref direction, marginA * lengthSquared, out contribution);
                Vector3.Add(ref toExpandA, ref contribution, out toExpandA);
                Vector3.Mul(ref direction, marginB * lengthSquared, out contribution);
                Vector3.Sub(ref toExpandB, ref contribution, out toExpandB);
            }
