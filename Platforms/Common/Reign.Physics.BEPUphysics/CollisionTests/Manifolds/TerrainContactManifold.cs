    ...
    public abstract class TerrainContactManifold : TriangleMeshConvexContactManifold
    {
        ...
        protected internal override int FindOverlappingTriangles(float dt)
        {
            ...
            if (convex.entity != null)
            {
                ...
                Matrix3 inverse;
                Matrix3.Invert(ref terrain.worldTransform.Transform, out inverse);
                Vector3.Transform(ref convex.entity.linearVelocity, ref inverse, out transformedVelocity);
        ...
        protected override void ProcessCandidates(RawValueList<ContactData> candidates)
        {
            ...
            {
                RayHit rayHit;
                Ray3 ray = new Ray3() { Position = convex.worldTransform.Position, Direction = terrain.worldTransform.Transform.Up };
                ...
                {
                    //Found a hit!
                    rayHit.Normal = rayHit.Normal.Normalize();
                    float dot;
