    ...
    public abstract class InstancedMeshContactManifold : TriangleMeshConvexContactManifold
    {
        ...
        protected internal override int FindOverlappingTriangles(float dt)
        {
            ...
            if (convex.entity != null)
            {
                ...
                Matrix3 inverse;
                Matrix3.Invert(ref mesh.worldTransform.Transform, out inverse);
        ...
        protected override bool ConfigureTriangle(int i, out TriangleIndices indices)
        {
            ...
            Vector3.Transform(ref localTriangleShape.vA, ref mesh.worldTransform, out localTriangleShape.vA);
            Vector3.Transform(ref localTriangleShape.vB, ref mesh.worldTransform, out localTriangleShape.vB);
            Vector3.Transform(ref localTriangleShape.vC, ref mesh.worldTransform, out localTriangleShape.vC);
