...
namespace BEPUphysics.CollisionTests.Manifolds
{
    ...
    public class TriangleConvexContactManifold : ContactManifold
    {
        ...
        public override void Update(float dt)
        {
            ...
            Matrix3 orientation;
            Matrix3.FromQuaternion(ref triangle.worldTransform.Orientation, out orientation);
            Vector3.Transform(ref triangle.Shape.vA, ref orientation, out localTriangleShape.vA);
            Vector3.Transform(ref triangle.Shape.vB, ref orientation, out localTriangleShape.vB);
            Vector3.Transform(ref triangle.Shape.vC, ref orientation, out localTriangleShape.vC);
        ...
        protected override void Add(ref ContactData contactCandidate)
        {
            ...
            Vector3.TransformInversed(ref contactCandidate.Position, ref triangle.worldTransform, out supplement.LocalOffsetB);
        ...
        private bool IsContactUnique(ref ContactData contactCandidate)
        {
            ...
            for (int i = 0; i < contacts.count; i++)
            {
                ...
                if (distanceSquared < CollisionDetectionSettings.ContactMinimumSeparationDistanceSquared)
                {
                    ...
                    Vector3.TransformInversed(ref contactCandidate.Position, ref triangle.worldTransform, out supplementData.Elements[i].LocalOffsetB);
                    return false;
                }
            }
            return true;
