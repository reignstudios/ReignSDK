...
namespace BEPUphysics.BroadPhaseSystems.Hierarchies
{
    internal abstract class Node
    {
        ...
        internal abstract void GetOverlaps(ref BoundingBox3 boundingBox, IList<BroadPhaseEntry> outputOverlappedElements);
        internal abstract void GetOverlaps(ref BoundingSphere3 boundingSphere, IList<BroadPhaseEntry> outputOverlappedElements);
        internal abstract void GetOverlaps(ref BoundingFrustum3 boundingFrustum, IList<BroadPhaseEntry> outputOverlappedElements);
        internal abstract void GetOverlaps(ref Ray3 ray, float maximumLength, IList<BroadPhaseEntry> outputOverlappedElements);
    ...
    internal sealed class InternalNode : Node
    {
        ...
        internal override void GetOverlaps(ref BoundingBox3 boundingBox, IList<BroadPhaseEntry> outputOverlappedElements)
        {
        ...
        internal override void GetOverlaps(ref BoundingSphere3 boundingSphere, IList<BroadPhaseEntry> outputOverlappedElements)
        {
            bool intersects;
        ...
        internal override void GetOverlaps(ref BoundingFrustum3 boundingFrustum, IList<BroadPhaseEntry> outputOverlappedElements)
        {
            bool intersects;
        ...
        internal override void GetOverlaps(ref Ray3 ray, float maximumLength, IList<BroadPhaseEntry> outputOverlappedElements)
        {
            float? result;
        ...
        internal override void GetOverlaps(Node opposingNode, DynamicHierarchy owner)
        {
            ...
            if (this == opposingNode)
            {
                ...
                BoundingBox3.Intersects(ref childA.BoundingBox, ref childB.BoundingBox, out intersects);
                if (intersects)
        ...
        void Reconstruct(RawList<LeafNode> leafNodes, int begin, int end)
        {
            ...
            BoundingBox3.Merge(ref leafNodes.Elements[begin].BoundingBox, ref leafNodes.Elements[begin + 1].BoundingBox, out BoundingBox);
            for (int i = begin + 2; i < end; i++)
            {
                BoundingBox3.Merge(ref BoundingBox, ref leafNodes.Elements[i].BoundingBox, out BoundingBox);
            }
            Vector3 offset;
            Vector3.Sub(ref BoundingBox.Max, ref BoundingBox.Min, out offset);
        ...
        internal override bool RemoveFast(BroadPhaseEntry entry, out LeafNode leafNode, out Node replacementNode)
        {
            ...
            bool intersects;
            BoundingBox3.Intersects(ref childA.BoundingBox, ref entry.boundingBox, out intersects);
            ...
            BoundingBox3.Intersects(ref childB.BoundingBox, ref entry.boundingBox, out intersects);
    ...
    internal sealed class LeafNode : Node
    {
        ...
        internal override bool TryToInsert(LeafNode node, out Node treeNode)
        {
            ...
            Vector3 offset;
            Vector3.Sub(ref newTreeNode.BoundingBox.Max, ref newTreeNode.BoundingBox.Min, out offset);
