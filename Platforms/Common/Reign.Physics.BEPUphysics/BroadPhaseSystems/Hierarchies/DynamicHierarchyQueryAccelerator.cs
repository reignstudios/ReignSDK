...
namespace BEPUphysics.BroadPhaseSystems.Hierarchies
{
    ...
    public class DynamicHierarchyQueryAccelerator : IQueryAccelerator
    {
        ...
        public void GetEntries(BoundingBox3 box, IList<BroadPhaseEntry> entries)
        {
        ...
        public void GetEntries(BoundingFrustum3 frustum, IList<BroadPhaseEntry> entries)
        {
            if (hierarchy.root != null)
        ...
        public void GetEntries(BoundingSphere3 sphere, IList<BroadPhaseEntry> entries)
        {
            if (hierarchy.root != null)
        ...
        /// </summary>
        /// <param name="ray">Ray3 to test against the structure.</param>
        ...
        public bool RayCast(Ray3 ray, float maximumLength, IList<BroadPhaseEntry> entries)
        {
            if (hierarchy.root != null)
            {
        ...
        /// <param name="ray">Ray3 to test against the structure.</param>
        /// <param name="entries">Entries which have bounding boxes that overlap the ray.</param>
        public bool RayCast(Ray3 ray, IList<BroadPhaseEntry> entries)
        {
            if (hierarchy.root != null)
            {
