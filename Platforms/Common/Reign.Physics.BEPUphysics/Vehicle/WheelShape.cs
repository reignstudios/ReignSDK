...
namespace BEPUphysics.Vehicle
{
    ...
    public abstract class WheelShape : ICollisionRulesOwner
    {
        ...
        protected internal Matrix4 localGraphicTransform;
        ...
        internal Matrix4 steeringTransform;
        protected internal Wheel wheel;

        protected internal Matrix4 worldTransform;
        ...
        /// </summary>
        public Matrix4 LocalGraphicTransform
        {
        ...
        internal void UpdateSpin(float dt)
        {
            ...
            else if (!wheel.HasSupport && wheel.drivingMotor.TargetSpeed != 0)
            {
                ...
                spinVelocity = MathUtilities.Clamp(spinVelocity + Math.Sign(wheel.drivingMotor.TargetSpeed) * airborneWheelAcceleration * dt, -maxSpeed, maxSpeed);
            }
