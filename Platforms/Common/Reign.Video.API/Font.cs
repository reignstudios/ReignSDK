...
namespace Reign.Video.Abstraction
{
	...
	public class Font : DisposableResource, ILoadable
	{
		#region Properties
		...
		private IShaderVariable shaderCamera, shaderPosition, shaderSize, shaderPositionUV, shaderSizeUV, texelOffset, shaderColor;
		private IShaderResource shaderTexture;
		private ITexture2D texture;
		private IBufferLayout layout;
