...
{
	public class Mesh : DisposableResource
	{
		#region Properties
		...
		public IBufferLayoutDesc LayoutDesc {get; private set;}

		public IVertexBuffer InstancingVertexBuffer {get; private set;}
		public IIndexBuffer InstancingIndexBuffer {get; private set;}
		public IBufferLayoutDesc InstancingLayoutDesc {get; private set;}
