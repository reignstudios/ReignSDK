	...
	public static class BlendStateDesc
	{
		public static BlendStateDescI Create(VideoTypes apiType, params object[] args)
		{
			try
			{
				...
				{
					return (BlendStateDescI)OS.CreateInstance(Video.D3D10, Video.D3D10, "BlendStateDesc", args);
				}
	...
	public static class BlendState
	{
		public static BlendStateI Create(VideoTypes apiType, params object[] args)
		{
			try
			{
				...
				if (apiType == VideoTypes.D3D10)
				{
					return (BlendStateI)OS.CreateInstance(Video.D3D10, Video.D3D10, "BlendState", args);
				}
