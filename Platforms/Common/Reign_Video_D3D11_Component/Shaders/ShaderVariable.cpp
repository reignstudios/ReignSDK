...
namespace Reign_Video_D3D11_Component
{
	...
	void ShaderVariableCom::Set(IntPtr data, int size)
	{
	...
	void ShaderVariableCom::Set(IntPtr data, int size, int objectCount, int dataOffset)
	{
		char* ptr = (char*)data.ToPointer();
		if (vertexOffset != -1)
		{
